	...
	,m_SL(nullptr)
{
	...
	m_DL->Ambient = Vec4(0.2f, 0.2f, 0.2f, 1.0f);
	m_DL->Diffuse = Vec4(0.5f, 0.5f, 0.5f, 1.0f);
	m_DL->Specular = Vec4(0.5f, 0.5f, 0.5f, 1.0f);
	m_DL->Direction = Vec3(0.57735f, -0.57735f, 0.57735f);
