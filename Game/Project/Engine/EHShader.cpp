...
void Shader::Create(wstring& _shaderPath, string& _vsEntry, string& _psEntry)
{
	// CreateBlob
...
void Shader::CreateBlobFile(SHADER_TYPE _type, wstring& _path, string& _entry)
{
...
void Shader::CreateShader(SHADER_TYPE _type)
{
	switch (_type)
	{
	case SHADER_TYPE::VERTEX:
...
void Shader::SetShader(SHADER_TYPE _type)
{
	switch (_type)
	{
	case SHADER_TYPE::VERTEX:
