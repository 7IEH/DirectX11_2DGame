...
void Animator2DUI::Render_Update()
{
	...
	******************************/
	...
	// 현재 애니메이션 정보 가져옴
	// string 변환까지 Imgui 용
	wstring _wcurAnimation2D = _animator->GetCurAnimation2D()->GetName();
	...
	*************************/
	...
	float _texWidth = _curAtlas.Get()->GetSpriteWidth();
	float _texHeight = _curAtlas.Get()->GetSpriteHeight();
