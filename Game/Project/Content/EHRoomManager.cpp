...
void RoomManager::Awake()
{
	...
	_temp.CurPos = Content::Vec2(0.f, 0.f);
	...
	_temp2.CurPos = Content::Vec2(0.f, 0.f);
	...
	_temp3.CurPos = Content::Vec2(0.f, 0.f);
	...
	_temp4.CurPos = Content::Vec2(0.f, 0.f);
	...
	_tempSpawn._SpawnPos = SPAWN_TYPE::TOP;
	_temp5.Spawn.push_back(_tempSpawn);
	_temp5.CurPos = Content::Vec2(0.f, 0.f);
	...
	_tempSpawn._SpawnPos = SPAWN_TYPE::TOP;
	_temp6.Spawn.push_back(_tempSpawn);
	_temp6.CurPos = Content::Vec2(0.f, 0.f);
	...
	_tempSpawn._SpawnPos = SPAWN_TYPE::BOTTOM;
	_temp7.Spawn.push_back(_tempSpawn);
	_temp7.CurPos = Content::Vec2(0.f, 0.f);
	...
	_tempSpawn._SpawnPos = SPAWN_TYPE::BOTTOM;
	_temp8.Spawn.push_back(_tempSpawn);
	_temp8.CurPos = Content::Vec2(0.f, 0.f);
	...
	_tempSpawn._SpawnPos = SPAWN_TYPE::LEFT;
	_temp9.Spawn.push_back(_tempSpawn);
	_temp9.CurPos = Content::Vec2(0.f, 0.f);
	...
	_tempSpawn._SpawnPos = SPAWN_TYPE::BOTTOM;
	_temp10.Spawn.push_back(_tempSpawn);
	_temp10.CurPos = Content::Vec2(0.f, 0.f);
